<acl>
    ...
    <group name="Admin">
        ...
        <acl name="Admin"></acl>
        <acl name="RPC"></acl>
        <object name="user.Chex"></object>
        <object name="resource.admin"></object>
        <object name="resource.webadmin"></object>
        <object name="user.Miller"></object>
    </group>
    <group name="Console">
        <acl name="Moderator"></acl>
        <acl name="SuperModerator"></acl>
    ...
    <group name="autoGroup_tactics">
        <acl name="autoACL_tactics"></acl>
    ...
    <acl name="Default">
        ...
        <right name="general.tactics_players" access="false"></right>
        <right name="general.tactics_maps" access="false"></right>
        <right name="general.tactics_configs" access="false"></right>
        <right name="general.tactics_handling" access="false"></right>
        <right name="general.tactics_teams" access="false"></right>
        <right name="general.tactics_adminchat" access="false"></right>
        <right name="general.tactics_shooting" access="false"></right>
        <right name="general.tactics_openpanel" access="false"></right>
        <right name="general.tactics_weather" access="false"></right>
        <right name="general.tactics_vehicles" access="false"></right>
        <right name="general.tactics_weapons" access="false"></right>
        <right name="general.tactics_anticheat" access="false"></right>
        <right name="general.tactics_settings" access="false"></right>
    </acl>
    <acl name="Moderator">
        <right name="general.ModifyOtherObjects" access="false"></right>
    ...
    <acl name="autoACL_tactics">
        ...
        <right name="general.ModifyOtherObjects" access="false" who="" pending="true" date=""></right>
        <right name="function.callRemote" access="false" who="" pending="true" date=""></right>
        <right name="function.getClientIP" access="false" who="" pending="true" date=""></right>
        <right name="function.kickPlayer" access="false" who="" pending="true" date=""></right>
        <right name="function.redirectPlayer" access="false" who="" pending="true" date=""></right>
    </acl>
    <acl name="Tactics">
        <right name="function.callRemote" access="true"></right>
